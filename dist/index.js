"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }// src/_client/index.js





var _runtime = require('@genql/runtime');
...
var typeMap = _runtime.linkTypeMap.call(void 0, types_esm_default);
var version = "2.10.0";
_runtime.assertSameVersion.call(void 0, version);
var createClient = function(options) {
  ...
  return _runtime.createClient.call(void 0, optionsCopy);
};
...
var generateQueryOp = function(fields) {
  return _runtime.generateGraphqlOperation.call(void 0, "query", typeMap.Query, fields);
};
var generateMutationOp = function(fields) {
  return _runtime.generateGraphqlOperation.call(void 0, "mutation", typeMap.Mutation, fields);
};
var generateSubscriptionOp = function(fields) {
  return _runtime.generateGraphqlOperation.call(void 0, "subscription", typeMap.Subscription, fields);
};
var everything = {
  __scalar: true
};
...
// src/index.ts
var createClient2 = ({ apiKey, ...options }) => {
  ...
  const { mutation, wsClient, ...client } = createClient(options);
  return client;
};
...
exports.createClient = createClient2; exports.enumDistanceUnit = enumDistanceUnit; exports.enumDurationUnit = enumDurationUnit; exports.enumFeedSourceUrlTypes = enumFeedSourceUrlTypes; exports.enumFeedSpecTypes = enumFeedSpecTypes; exports.enumImportStatus = enumImportStatus; exports.enumRole = enumRole; exports.enumScheduleRelationship = enumScheduleRelationship; exports.enumStepMode = enumStepMode; exports.everything = everything; exports.generateMutationOp = generateMutationOp; exports.generateQueryOp = generateQueryOp; exports.generateSubscriptionOp = generateSubscriptionOp; exports.isAgency = isAgency; exports.isAgencyPlace = isAgencyPlace; exports.isAlert = isAlert; exports.isCalendar = isCalendar; exports.isCensusGeography = isCensusGeography; exports.isCensusTable = isCensusTable; exports.isCensusValue = isCensusValue; exports.isDirections = isDirections; exports.isDistance = isDistance; exports.isDuration = isDuration; exports.isFeed = isFeed; exports.isFeedAuthorization = isFeedAuthorization; exports.isFeedFetch = isFeedFetch; exports.isFeedInfo = isFeedInfo; exports.isFeedLicense = isFeedLicense; exports.isFeedState = isFeedState; exports.isFeedUrls = isFeedUrls; exports.isFeedVersion = isFeedVersion; exports.isFeedVersionDeleteResult = isFeedVersionDeleteResult; exports.isFeedVersionFetchResult = isFeedVersionFetchResult; exports.isFeedVersionFileInfo = isFeedVersionFileInfo; exports.isFeedVersionGtfsImport = isFeedVersionGtfsImport; exports.isFeedVersionImportResult = isFeedVersionImportResult; exports.isFeedVersionServiceLevel = isFeedVersionServiceLevel; exports.isFeedVersionUnimportResult = isFeedVersionUnimportResult; exports.isFrequency = isFrequency; exports.isItinerary = isItinerary; exports.isLeg = isLeg; exports.isLevel = isLevel; exports.isMutation = isMutation; exports.isOperator = isOperator; exports.isPathway = isPathway; exports.isQuery = isQuery; exports.isRTTimeRange = isRTTimeRange; exports.isRTTranslation = isRTTranslation; exports.isRTTripDescriptor = isRTTripDescriptor; exports.isRTVehicleDescriptor = isRTVehicleDescriptor; exports.isRoute = isRoute; exports.isRouteGeometry = isRouteGeometry; exports.isRouteHeadway = isRouteHeadway; exports.isRouteStop = isRouteStop; exports.isRouteStopBuffer = isRouteStopBuffer; exports.isShape = isShape; exports.isStep = isStep; exports.isStop = isStop; exports.isStopTime = isStopTime; exports.isStopTimeEvent = isStopTimeEvent; exports.isTrip = isTrip; exports.isValidationResult = isValidationResult; exports.isValidationResultError = isValidationResultError; exports.isValidationResultErrorGroup = isValidationResultErrorGroup; exports.isVehiclePosition = isVehiclePosition; exports.isWaypoint = isWaypoint; exports.version = version;
